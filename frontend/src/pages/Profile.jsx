                    ...
                    <div className="flex items-center gap-8 min-w-max">
                        {['overview', 'achievements'].map(tab => (
                            <button
                                ...
                                className={`py-4 text-sm font-bold capitalize transition-all relative ${activeTab === tab ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'
                                    }`}
                            >
                                {tab}
                                {activeTab === tab && (
                            ...
                            return (
                                <div key={achievement.id} className={`p-6 rounded-3xl border transition-all duration-300 relative overflow-hidden group ${achievement.unlocked ? `bg-gradient-to-br from-white to-${achievement.theme}-50/30 dark:from-[#1e1e2e] dark:to-${achievement.theme}-900/10 border-${achievement.theme}-200 dark:border-${achievement.theme}-500/30 shadow-sm hover:shadow-md hover:-translate-y-1` : 'bg-gray-50 dark:bg-[#1e1e2e]/50 border-gray-200/50 dark:border-white/5 opacity-70'
                                    ...
                                    <div className="flex items-start gap-4 relative z-10">
                                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 ${achievement.unlocked ? `bg-gradient-to-br from-${achievement.theme}-100 to-${achievement.theme}-50 dark:from-${achievement.theme}-500/20 dark:to-${achievement.theme}-500/5 text-${achievement.theme}-600 dark:text-${achievement.theme}-400 shadow-inner border border-${achievement.theme}-200/50 dark:border-${achievement.theme}-500/20` : 'bg-gray-200 dark:bg-[#272739] text-gray-400 dark:text-gray-500'
                                            }`}>
